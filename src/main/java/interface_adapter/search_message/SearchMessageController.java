...
/**
 * The SearchMessagesController is responsible for handling user input for the search.
...
public class SearchMessageController {
    ...
    /**
     * Constructs a new SearchMessagesController.
     *
    ...
    /**
     * Handles the search input from the user.
     *
